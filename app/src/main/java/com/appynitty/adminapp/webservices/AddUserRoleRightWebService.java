...
public interface AddUserRoleRightWebService {
    ...
    Call<AddUserRoleRightResult> addNewUserRoleRightHS(@Header("Content-Type") String content_type,
                                                       @Body List<AddUserRoleRightDTO> addUserRoleRightDTOS);

    @POST("api/Supervisor/AddHouseScanifyUserRole")
    Call<AddUserRoleRightResult> updateUserRoleRightHS(@Header("Content-Type") String content_type,
